        ...
        <div class="container-fluid">
            <div class="jumbotron">
                ...
                <form class="form-uel" role="form" action="${pageContext.servletContext.contextPath}/usuario/create" method="POST">
                    ...
                    <div class="form-group">
                        <label for="inputLocal">Departamento</label>
                        <div class="input-group inputGroupLocal">
                            <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">Selecione um departamento <span class="caret"></span></button>
                            ...
                            <input type="hidden" class="form-control category" id="inputLocal" name="departamento" required="true">
                        </div>
                    </div>
                    <div class="form-group">
